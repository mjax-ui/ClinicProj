...
<div class="container animate-fade-in" style="margin-top: 100px; text-align: center;">
    <h1 style="font-size: 50px; margin-bottom: 5px;">Book an Appointment</h1>
    ...
    <div class="center-card" style="width: 500px; padding: 40px;">
        ...
        <form action="schedule_ticket.php" method="GET">
            <div class="form-group">
                <input type="text" name="fullname" class="form-control" placeholder="Full Name" style="text-align: center;">
            </div>
            <div class="form-group">
                <input type="tel" name="phone" class="form-control" placeholder="Phone Number" style="text-align: center;">
            </div>
            <div class="form-group">
                <input type="date" name="date" class="form-control" style="text-align: center;">
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary" style="margin-top: 10px; border-radius: 30px; width: 50%;">Submit</button>
        </form>
    </div>
</div>
